            ...
            <div className="flex-1 flex flex-col md:flex-row justify-between md:items-center">
                ...
                <div>
                    <div className="w-30 flex text-gray-500 border border-gray-200 rounded-sm text-center">
                        <div onClick={handleMinus} className="cursor-pointer size-10 text-2xl flex justify-center items-center">
                            -
                        </div>
                        <div className="size-10 text-lg border-x border-gray-200 flex justify-center items-center">
                            {item.quantity}
                        </div>
                        <div onClick={handlePlus} className="cursor-pointer size-10 text-2xl flex justify-center items-center">
                            +
                        </div>
                    </div>
                </div>
            </div>
            <div className="w-24 md:w-40 flex flex-col md:flex-row items-end justify-between md:items-center">
